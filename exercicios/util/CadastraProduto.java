...
public class CadastraProduto {
	public static void main(String[] args) {
		...
		lista.adicionarProduto(10, "Carro", 1);
		lista.adicionarProduto(20, "Moto", 3);
		lista.adicionarProduto(30, "Caminhão", 1);
		lista.adicionarProduto(40, "Onibus", 2);
		lista.imprimirLista();
		lista.removerProduto(1);

		lista.imprimirLista();
		if (lista.pesquisar(20) != -1) {
		    System.out.println("O produto de ID '20' está presente");
		}
		else {
		    System.out.println("O produto de ID '20' NÃO está presente");
		}
